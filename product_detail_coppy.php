                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <ul class="breadcrumb-link">
                           ...
                           <li>Printed Round White T-shirt</li>
                        </ul>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-12 mb-30">
                        <div class="product-detail-image">
                           <div class="product-detail-slider product-image-gallery" id="product-image-gallery" data-pswp-uid="3">
                              <div class="item">
                                 <a class="product-gallery-item" href="img/product/big/01.jpg" data-size="" data-med="img/product/big/01.jpg" data-med-size="">
                                 <img src="img/product/big/01.jpg" alt="image 1" />
                                 </a>
                              </div>
                              <div class="item">
                                 <a class="product-gallery-item" href="img/product/big/02.jpg" data-size="" data-med="img/product/big/02.jpg" data-med-size="">
                                 <img src="img/product/big/02.jpg" alt="image 1" />
                                 </a>
                              </div>
                              <div class="item">
                                 <a class="product-gallery-item" href="img/product/big/03.jpg" data-size="" data-med="img/product/big/03.jpg" data-med-size="">
                                 <img src="img/product/big/03.jpg" alt="image 1" />
                                 </a>
                              </div>
                              <div class="item">
                                 <a class="product-gallery-item" href="img/product/big/04.jpg" data-size="" data-med="img/product/big/04.jpg" data-med-size="">
                                 <img src="img/product/big/04.jpg" alt="image 1" />
                                 </a>
                              </div>
                              <div class="item">
                                 <a class="product-gallery-item" href="img/product/big/05.jpg" data-size="" data-med="img/product/big/05.jpg" data-med-size="">
                                 <img src="img/product/big/05.jpg" alt="image 1" />
                                 </a>
                              </div>
                              <div class="item">
                                 <a class="product-gallery-item" href="img/product/big/06.jpg" data-size="" data-med="img/product/big/06.jpg" data-med-size="">
                                 <img src="img/product/big/06.jpg" alt="image 1" />
                                 </a>
                              </div>
                           </div>
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-12 mb-30">
                        <div class="product-detail-content">
                           <h2 class="product-title">Printed Round White T-shirt</h2>
                           ...
                           <div class="product-price">
                              <del>$99.00</del><span><span class="product-price-text color">$49.00</span></span>
                           </div>
                           ...
                           <div class="product-detail-filters">
                              <div class="filters-color">
                                 ...
                                 <div class="color-box-wrapper">
                                    <div class="color-box active red-box"></div>
                           ...
                           <div class="signle-product-qty-wrapper">
                              <div class="product-qty">                                 
                                 <input class="qty input-lg" step="1" min="1" max="20" name="intqty" value="1" title="Quantity" type="number" />
                                 <span data-value="-" class="qty-btn qtyminus-btn"></span>
                                 <span data-value="+" class="qty-btn qtyplus-btn"></span>                                 
                              </div>
                              <button type="submit" class="btn btn-lg btn-black">Add to cart</button>
                           </div>
                           ...
                           <div class="signle-product-meta">
                              <span>SKU : <span class="sku">Product SKU</span></span>
                              <span>Category : <span class="category">Brand, Men</span></span>
                              <span>Tag : <span class="tag">fashion, t-shirt</span></span>
                           </div>
                  ...
                  <div class="container">
                     ...
                     <div class="carousel-item-4 owl-carousel owl-theme theme-carousel">
                        ...
                        <div class="product-item">
                           <div class="product-item-wraper">
                              <div class="product-image-wraper">
                                 <a href="#"><img src="img/product/big/07.jpg" alt="" data-src="img/product/big/08.jpg" /></a>
                              </div>
                           ...
                           <div class="product-item-detail">
                              <p class="product-title"><a href="#">Printed Round White T-shirt</a></p>
                              <h6 class="product-price color"><del>$99</del>$49</h6>
                           </div>
                        </div>
                        <!-- item -->
                        <div class="product-item">
                           <div class="product-item-wraper">
                              <div class="product-image-wraper">
                                 <a href="#"><img src="img/product/big/01.jpg" alt="" data-src="img/product/big/09.jpg" /></a>
                              </div>
                              <div class="product-item-button">
                                 <a href="#" data-toggle="tooltip" data-placement="left" title="Add to Wishlist"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                 <a href="#" data-toggle="tooltip" data-placement="left" title="Add to Cart"><i class="fa fa-shopping-basket" aria-hidden="true"></i></a>
                        ...
                        <div class="product-item">
                           <div class="product-item-wraper">
                              <div class="product-image-wraper">
                                 <a href="#"><img src="img/product/big/02.jpg" alt="" data-src="img/product/big/10.jpg" /></a>
                              </div>
                              <div class="product-item-button">
                                 <a href="#" data-toggle="tooltip" data-placement="left" title="Add to Wishlist"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                 <a href="#" data-toggle="tooltip" data-placement="left" title="Add to Cart"><i class="fa fa-shopping-basket" aria-hidden="true"></i></a>
                        ...
                        <div class="product-item">
                           <div class="product-item-wraper">
                              <div class="product-image-wraper">
                                 <a href="#"><img src="img/product/big/03.jpg" alt="" data-src="img/product/big/11.jpg" /></a>
                              </div>
                              <div class="product-item-button">
                                 <a href="#" data-toggle="tooltip" data-placement="left" title="Add to Wishlist"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                 <a href="#" data-toggle="tooltip" data-placement="left" title="Add to Cart"><i class="fa fa-shopping-basket" aria-hidden="true"></i></a>
                        ...
                        <div class="product-item">
                           <div class="product-item-wraper">
                              <div class="product-image-wraper">
                                 <a href="#"><img src="img/product/big/04.jpg" alt="" data-src="img/product/big/12.jpg" /></a>
                              </div>
                              <div class="product-item-button">
                                 <a href="#" data-toggle="tooltip" data-placement="left" title="Add to Wishlist"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                 <a href="#" data-toggle="tooltip" data-placement="left" title="Add to Cart"><i class="fa fa-shopping-basket" aria-hidden="true"></i></a>
                        ...
                        <div class="product-item">
                           <div class="product-item-wraper">
                              <div class="product-image-wraper">
                                 <a href="#"><img src="img/product/big/05.jpg" alt="" data-src="img/product/big/13.jpg" /></a>
                              </div>
                              <div class="product-item-button">
                                 <a href="#" data-toggle="tooltip" data-placement="left" title="Add to Wishlist"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                 <a href="#" data-toggle="tooltip" data-placement="left" title="Add to Cart"><i class="fa fa-shopping-basket" aria-hidden="true"></i></a>
